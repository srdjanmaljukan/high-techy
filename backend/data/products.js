const products = [
    ...
    },
    {
        ...
        description: 'Introducing the iPhone 11 Pro. A transformative triple-camera system that adds tons of capability wihout complexity. An unprecedented leap in battery life',
        brand: 'Apple',
        category: 'Electronics',
        price: 599.99,
        countInStock: 7,
    ...
    },
    {
        ...
        description: 'Characterized by versatile imaging specs, the Canon EOS 80D clarifies itself using a pair of robust focusing systems and an inovative design',
        brand: 'Canon',
        category: 'Electronics',
        price: 328.99,
        countInStock: 5,
